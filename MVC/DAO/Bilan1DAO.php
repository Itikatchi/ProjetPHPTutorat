    ...
    public function find(int $id): object
    {
        ...
        if ($r !== false) {
            ...
            if (!is_null($row)) {
                ...
                $date = $row['bil1_date_visite_ent'] != null ? new DateTime($row['bil1_date_visite_ent']) : null;
                $result = new Bilan1($row['bil1_note_entreprise'],$date,$row['bil1_id'],$row['bil1_remarques'],$row['bil1_note_dossier'],$row['bil1_note_oral'],$etudiant);
            }
        }
        return $result;
    }
